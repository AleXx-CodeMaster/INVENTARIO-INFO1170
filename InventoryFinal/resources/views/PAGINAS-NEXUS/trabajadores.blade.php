...
<body id="body">
    ...
    <div class="Cuerpo__Pagina">
        <header id="Encabezado"><h1>Registros de empleados</h1></header>
        <div class="PANEL__BUTTON">
            <div class="BUtton">
                <button id="BotonExistencia">Añadir Trabjador</button>
                <button id="BotonAntiguo">Trabajadores Posteriores</button>
             </div>
            <div class="Search">
                <form action="Buscar">
                    <input id="Buscador" type="text" class="Selector" placeholder="Buscar Trabajador">
                ...
                <table class="table table-data2">
                    ...
                    <tbody>
                        <tr class="tr-shadow">
                            ...
                            <td><span>21.607.907-8</span></td>
                            <td><span>Trbajador@gmail.com</span> </td>
                            <td><span>+56 9000 8097</span> </td>
                            <td><span>31 de Julio 2023</span> </td>
                            <td><span>En línea</span> </td>
                            <td><!--ITEM-compartir-modificar-eliminar-másInformación--->
                                <div class="BOTONES_SELECCION">
                                    <button id="Compartir"   title="Compartir"> </button>
        ...
        <div id="add" class="modal">
            <div class="modal-content">
                <div id="Form">
                    ...
                    <input type="text" class="Selector" placeholder="Rut"> <br>
                    <input type="text" class="Selector" placeholder="Correo"> <br>
                    <input type="text" class="Selector" placeholder="Telefono"><br>
                    <input type="password" class="Selector" placeholder="Contraseña"><br>
                    <input type="password" class="Selector" placeholder="Repita Contraseña"><br>
                    <div id="Bu">
        ...
        <div id="antiguo" class="modal">
            <div class="modal-content">
                <div id="Form">
                <h1>Trabajadores Posteriores</h1>
