...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/olvido-contraseña.css')}}">
</head>
<body>
    <div class="container">
        <div class="login">
    ...
    <section>
        <form>
            ...
            <p style="color: azure; text-align: center; margin-top: 20px;">Por favor, introduce tu dirección de correo electrónico. Te enviaremos un enlace para restablecer tu contraseña.</p>
            <div class="inputbox">
      ...
      <script src="js/olvido-contraseña.js"></script>
</body>
</html>
