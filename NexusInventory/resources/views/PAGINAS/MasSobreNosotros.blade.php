...
<div class="CuerpoPagina">
    ...
    <main class="C-MAS2">
        <section Class = 'Contenedor' id="C1">
            ...
            <div class = 'imagen'>
                <img id = 'Logo' src="Logo.jpg" alt="Logo de nuestra aplicación web" width="300px">
            </div>
        </section>
        ...
        <section Class = 'Contenedor' id="C3">
            <div class ="Cont">
                <h2>Como fue creada la pagina</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore facilis ipsa cumque dolor modi aliquid
                    voluptas, magnam obcaecati deserunt aperiam nihil commodi nisi temporibus, laborum sapiente unde molestias?
                    Nihil magni amet maiores quidem quae ad sequi odio ipsam repellat, voluptates, et quos laboriosam nisi.
                    Cumque perspiciatis magnam et, ea odio quasi rerum asperiores, obcaecati ab impedit sit assumenda voluptatibus
            ...
            <div class="imagen" id="Img3" >
                <img src="https://img.freepik.com/vector-premium/icono-personas-dibujos-animados-estilo-comic-pictograma-ilustracion-usuarios-trabajo-equipo-persona-signo-splash-concepto-negocio_157943-4266.jpg?w=2000" alt="Imagen de nosotros , Iconos">
                <img src="https://img.freepik.com/vector-premium/icono-personas-dibujos-animados-estilo-comic-pictograma-ilustracion-usuarios-trabajo-equipo-persona-signo-splash-concepto-negocio_157943-4266.jpg?w=2000" alt="Imagen de nosotros , Iconos">
                <img src="https://img.freepik.com/vector-premium/icono-personas-dibujos-animados-estilo-comic-pictograma-ilustracion-usuarios-trabajo-equipo-persona-signo-splash-concepto-negocio_157943-4266.jpg?w=2000" alt="Imagen de nosotros , Iconos">
                <img src="https://img.freepik.com/vector-premium/icono-personas-dibujos-animados-estilo-comic-pictograma-ilustracion-usuarios-trabajo-equipo-persona-signo-splash-concepto-negocio_157943-4266.jpg?w=2000" alt="Imagen de nosotros , Iconos">
                <img src="https://img.freepik.com/vector-premium/icono-personas-dibujos-animados-estilo-comic-pictograma-ilustracion-usuarios-trabajo-equipo-persona-signo-splash-concepto-negocio_157943-4266.jpg?w=2000" alt="Imagen de nosotros , Iconos">
        ...
        <section Class = 'Contenedor' id="C4">
            <div class ="Cont">
                <h2>Contactanos</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore facilis ipsa cumque dolor modi aliquid
                    voluptas, magnam obcaecati deserunt aperiam nihil commodi nisi temporibus, laborum sapiente unde molestias?
                    ...
                    non exercitationem, omnis cum deleniti rem ad qui ex! Quae, aperiam magnam?</p></div>
            <div class = 'imagen'>
                <img src="https://depor.com/resizer/IJDgahyOVA0cq2NvyjgHE-wLm7A=/580x330/smart/filters:format(jpeg):quality(90)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/NEAIF2G5M5FIFLIO5GWMV4PMLM.jpg" alt="imagen o colocar otra cosa" width="200px"> </div>
        </section>
    </main>
