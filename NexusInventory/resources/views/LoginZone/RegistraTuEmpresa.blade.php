                        ...
                        <div class="card-wrap">
                            <div class="card-front">
                                <div class="center-wrap">
                                    ...
                                    <form action="{{ route('registerEM.store') }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                           <input type="number" name="CantidadEmpleados" class="form-style" placeholder="Cantidad de empleados" id="cantidadEmpleados" autocomplete="off">


                                        </div>
                                        <button type="submit" class="btn mt-4">Registrar tu empresa</button>
